![Latest Release](https://img.shields.io/github/v/release/SpellholdStudios/KorganFriendship?include_prereleases&color=darkred)<a name="top" id="top">
...
Visit the <a href="http://www.spellholdstudios.net/ie/npciep">website</a> or <a href="http://www.shsforums.net/index.php?showforum=353">forum</a> for all the latest updates.
...
The Korgan Friendship mod should be compatible with all WeiDU mods, however, we cannot test every single one. It is only compatible with BGII: ToB. If you do encounter an error, please let us know by posting the message at our forums.

>Although it is not required for the Korgan Friendship to function properly, it is always a good idea to install the latest version of the <a href="http://www.gibberlings3.net/bg2fixpack/">BG2 Fixpack</a>.
...
<em>If you've previously installed the mod, remove it before extracting the new version. To do this, run **`setup-korganfriendship.exe`**, un-install the previously installed main component and delete the :file_folder: korganfriendship folder.</em>
...
Extract the contents of the mod archive into the folder of the game you wish to modify (*the folder which contains the "CHITIN.KEY" file*), using <a href="http://www.7-zip.org/download.html">7zip</a>, <a href="http://www.rarlab.com/download.htm">WinRAR</a>, or another file compression utility that handles .zip files. On successful extraction, there should be a :file_folder: korganfriendship folder and a setup-korganfriendship.exe file in your game folder. To install, simply double-click **`setup-korganfriendship.exe`** and follow the instructions on screen.

Run **`setup-korganfriendship.exe`** in your game folder to reinstall, un-install or otherwise change the component settings.

## 

#### Note for Complete Un-installation

In addition to the methods above for removing individual components, you can completely un-install the mod using **`setup-korganfriendship --uninstall`** at the command line to remove all components without wading through prompts.</br>
<div align="right"><a href="#top">Back to top</a></div>
...
**Q: Is the Korgan Friendship compatible with XYZ mod?**  
A: It most certainly should be, but we have not tested it with every single mod available.

**Q: When will the friendship start?**  
A: After you join Korgan and finish his personal quest. The mod is build slightly differently than the other IEP mods - to enjoy most of the talks you'll need to visit some taverns and get Korgan drunk. You'll find details in the dialogue.
...
A: With this mod installed, you should be able to experience up to 18 dialogues in SoA (2 of those are recoded original dialogues) and up to 7 dialogues in ToB.

**Q: Does this mod change the game in any way besides adding more dialogue to Korgan?**  
A: No, it shouldn't.

**Q: Is there any chance that player initiated dialogue will be added in future?**  
A: There are currently no plans for it.

**Q: I would like to translate the Korgan friendship into another language. Any chance you could TRAify the mod?**  
...
#### Writing and coding: Lava Del'Vortel
#### Editing and additional writing: fluke13
#### Consultation: Rhaella, Kaeloree
...
###### The Korgan Friendship was developed by  Lava Del'Vortel and Rhaella, based on material from the game Baldur's Gate II and its expansion. All mod content is &copy; Lava Del'Vortel and Rhaella.
